...
$printedPosters = array();

function movieReviews() {
    global $posters;
    global $printedPosters;
    $randomPoster = $posters[rand(0,count($posters)-1)];
    // Array_push($printedPosters,$randomPoster);
    // $printedPosters = new ArrayObject($posters);
    // $printedPosters= $posters->getArrayCopy();
    // sort($printedPosters);
